...
namespace TicTacToe.ViewEngines
{
    public class EmailViewEngine : IEmailViewEngine
    {
        ...
        public EmailViewEngine(IRazorViewEngine viewEngine, ITempDataProvider tempDataProvider, IServiceProvider serviceProvider)
        {
        ...
        private IView FindView(ActionContext actionContext, string viewName)
        {
            ...
            var errorMessage = string.Join
                (Environment.NewLine, new[] { $"Unable to find view '{viewName}'. The following locations were searched:" }.Concat(searchedLocations));
